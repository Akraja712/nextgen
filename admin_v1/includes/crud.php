...
define('DOMAIN_URL', 'https://demonextgen.enlightapp.in/admin_v1/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
...
class Database
{
     ...
     */
     ...
     private $db_user = "u885242767_demo_nextgen";
     private $db_pass = "DemoNextgen@2025"; 
     private $db_name = "u885242767_demo_nextgen"; 
